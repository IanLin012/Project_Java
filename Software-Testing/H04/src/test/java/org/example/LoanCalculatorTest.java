...
class LoanCalculatorTest {
    @ParameterizedTest(name =
            "years={0}, amount={1}, young={2}, married={3} => expected{4}")
    @CsvSource({
            "5, 400, false, false, 5",
    ...
    void weakTest(
            int loanYears, double loanAmount,
            boolean isYouth, boolean isMarried, double expected) {
        assertEquals(expected, LoanCalculator.calculateInterestRate(
                loanYears, loanAmount*10000, isYouth, isMarried));
    }
